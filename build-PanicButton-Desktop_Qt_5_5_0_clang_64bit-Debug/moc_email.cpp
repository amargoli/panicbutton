...
const QMetaObject Email::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_Email.data,
      qt_meta_data_Email,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *Email::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_Email.stringdata0))
        return static_cast<void*>(const_cast< Email*>(this));
